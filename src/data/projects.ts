...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'Plataforma fullstack de despacho inteligente con arquitectura de microservicios, tracking GPS en tiempo real, scoring de riesgo IA y evidencia fotográfica de entrega.',
    tech: ['Next.js', 'TypeScript', 'Prisma', 'Supabase', 'Python', 'FastAPI', 'Turborepo'],
    image: '/images/project4.png',
    github: 'https://github.com/cristian102711/RuteAI',
    demo: 'https://ruteai.vercel.app',
    type: 'web',
  },
]
...
export const education: Education[] = [
  {
    ...
    description: 'Carrera técnica en desarrollo de software Full Stack con énfasis en aplicaciones web, móviles y bases de datos.',
    icon: 'graduation',
  },
  {
